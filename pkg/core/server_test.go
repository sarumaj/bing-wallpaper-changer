...
func TestServer_HandleConfig_GET(t *testing.T) {
...
func TestServer_HandleConfig_PATCH(t *testing.T) {
	cfg := &Config{ApiPort: 8080}
	controller := setupController(t, cfg, nil)
	server := NewServer(cfg, controller)
...
func TestServer_HandleConfig_PATCH_WithRefresh(t *testing.T) {
	cfg := &Config{ApiPort: 8080}
	executed := false
...
func TestServer_HandleConfig_InvalidMethod(t *testing.T) {
	cfg := &Config{}
	controller := setupController(t, cfg, nil)
	server := NewServer(cfg, controller)
